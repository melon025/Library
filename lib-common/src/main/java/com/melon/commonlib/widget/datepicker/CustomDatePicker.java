package info.emm.commonlib.widget.datepicker;
...
/**
 * from https://github.com/liuwan1992/CustomDatePicker
 */
public class CustomDatePicker implements View.OnClickListener, PickerView.OnSelectListener{
    ...
    public CustomDatePicker(Context context, Callback callback, String beginDateStr, String endDateStr) {
        this(context, callback, DateFormatUtil.str2Long(beginDateStr, true),
                DateFormatUtil.str2Long(endDateStr, true));
    }
    ...
    private void initView() {
        ...
        mPickerDialog.findViewById(R.id.lib_tv_cancel).setOnClickListener(this);
        mPickerDialog.findViewById(R.id.lib_tv_confirm).setOnClickListener(this);
        mTvHourUnit = mPickerDialog.findViewById(R.id.lib_tv_hour_unit);
        mTvMinuteUnit = mPickerDialog.findViewById(R.id.lib_tv_minute_unit);

        mDpvYear = mPickerDialog.findViewById(R.id.lib_dpv_year);
        mDpvYear.setOnSelectListener(this);
        mDpvMonth = mPickerDialog.findViewById(R.id.lib_dpv_month);
        mDpvMonth.setOnSelectListener(this);
        mDpvDay = mPickerDialog.findViewById(R.id.lib_dpv_day);
        mDpvDay.setOnSelectListener(this);
        mDpvHour = mPickerDialog.findViewById(R.id.lib_dpv_hour);
        mDpvHour.setOnSelectListener(this);
        mDpvMinute = mPickerDialog.findViewById(R.id.lib_dpv_minute);
    ...
    public void onClick(View v) {
        int i = v.getId();
        if (i == R.id.lib_tv_cancel) {
        } else if (i == R.id.lib_tv_confirm) {
            if (mCallback != null) {
    ...
    public void onSelect(View view, String selected) {
        ...
        int i = view.getId();
        if (i == R.id.lib_dpv_year) {
            mSelectedTime.set(Calendar.YEAR, timeUnit);
            linkageMonthUnit(true, LINKAGE_DELAY_DEFAULT);
        } else if (i == R.id.lib_dpv_month) {// 防止类似 2018/12/31 滚动到11月时因溢出变成 2018/12/01
    ...
    public boolean setSelectedTime(String dateStr, boolean showAnim) {
        return canShow() && !TextUtils.isEmpty(dateStr)
                && setSelectedTime(DateFormatUtil.str2Long(dateStr, mCanShowPreciseTime), showAnim);
    }
