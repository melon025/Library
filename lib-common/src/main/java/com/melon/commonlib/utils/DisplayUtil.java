...
public class DisplayUtil {
    ...
    public static int dp2px(float dpVal) {
        return (int) TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_DIP,
                dpVal, CommonApp.getAppContext().getResources().getDisplayMetrics());
    }
    ...
    public static int px2dip(float pxValue) {
        final float scale = CommonApp.getAppContext().getResources().getDisplayMetrics().density;
    ...
    public static int px2sp(float pxValue) {
        final float fontScale = CommonApp.getAppContext().getResources().getDisplayMetrics().scaledDensity;
