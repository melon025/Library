...
public abstract class CommonRecycleViewAdapter<T> extends RecyclerView.Adapter<ViewHolderHelper> implements DataIO<T> {
    ...
    private String itemMovedName = "CommonAdapter";
    private onRecyclerViewItemMovedListener itemMovedListener;
    ...
    /**
     * 设置对onMove data数据位置变化监听
     *
     * @param
     */
    public interface onRecyclerViewItemMovedListener {
        void notifyData();
    }

    public void setOnItemMovedListener(onRecyclerViewItemMovedListener listener) {
        this.itemMovedListener = listener;
